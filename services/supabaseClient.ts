...
// We use optional chaining (import.meta.env?.VARIABLE) to prevent runtime crashes 
// if import.meta.env is undefined (which can happen in some mixed module environments).
