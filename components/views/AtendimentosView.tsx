...
const AtendimentosView: React.FC<AtendimentosViewProps> = ({ onAddTransaction, onNavigateToCommand }) => {
    ...
    // --- LEITURA EXCLUSIVA DA VIEW (vw_agenda_completa) ---
    const fetchAppointments = async () => {
        ...
        try {
            ...
            // Mudança Crítica: Sempre ler de vw_agenda_completa
    ...
    // MAPEAR LINHA DA VIEW PARA O FORMATO LEGACY DO FRONTEND
    ...
    const handleSaveAppointment = async (app: LegacyAppointment, force: boolean = false) => {
        ...
        try {
            ...
            // PAYLOAD SANITIZADO PARA O BANCO (Tabela appointments)
            const payload = {
            ...
            fetchAppointments(); // Atualiza via View
        } catch (e: any) { 
