...
const AtendimentosView: React.FC<AtendimentosViewProps> = ({ onAddTransaction, onNavigateToCommand }) => {
    ...
    const fetchAppointments = async () => {
        ...
        try {
            ...
            // CORREÇÃO 409: Join explícito via FK appointments_professional_same_studio_fk
            ...
            console.error("AtendimentosView: Falha ao carregar agenda.", e);
        } finally { 
    ...
    const fetchResources = async () => {
        ...
        try {
            // CORREÇÃO 400: Alterado 'name' para 'nome' na ordenação
            ...
            console.error("AtendimentosView: fetchResources error", e); 
        }
    };
    ...
    const handleSaveAppointment = async (app: LegacyAppointment) => {
        ...
        try {
            ...
            setModalState(null);
            // SINCRO: Força recarregamento imediato
        ...
        <div className="h-full bg-white relative flex-col font-sans text-left overflow-hidden flex">
            ...
            {activeAppointmentDetail && (
                <AppointmentDetailPopover 
                    ...
                    onDelete={async (id) => { if(confirm("Apagar agendamento?")) { await supabase.from('appointments').delete().eq('id', id); fetchAppointments(); setActiveAppointmentDetail(null); } }} 
