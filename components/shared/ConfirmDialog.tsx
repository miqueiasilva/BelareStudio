...
const ConfirmDialog: React.FC<ConfirmDialogProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4">
      ...
      {/* Dialog Box */}
      <div
        className="relative w-full max-w-md bg-white rounded-[32px] shadow-2xl overflow-hidden border border-slate-100 z-10 transform scale-100 transition-all duration-300"
      >
        <div className="p-8">
