    ...
    useEffect(() => {
        ...
        const fetchSettings = async () => {
            ...
            try {
                ...
                else setFormData(p => ({ ...p, whatsapp_reminder_number: '', business_hours: sanitizeBusinessHours({}) }));
            } catch (err) {
